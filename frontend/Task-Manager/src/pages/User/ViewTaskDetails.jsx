...
const ViewTaskDetails = ({allowedRoles}) => {
    const { id } = useParams();
        ...
        <div className="form-card col-span-3">
          ...
          <div className="grid grid-cols-12 gap-4 mt-4">
              ...
              <div className="col-span-6 md:col-span-4">
                ...
                value = {task?.dueDate?moment(task?.dueDate).format("Do MMMM YYYY"):"N/A"}
                />
              </div>
              <div className="col-span-6 md:col-span-4">
...
const InfoBox =({ label, value}) =>{
  ...
  return( <>
    <div className="text-xs font-medium text-status-500">{label}</div>
